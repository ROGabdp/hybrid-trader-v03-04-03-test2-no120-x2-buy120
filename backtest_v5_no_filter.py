...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
使用範例:
  python backtest_v5_no_filter.py                           # 使用預設日期 (2023-01-01 至今)
  python backtest_v5_no_filter.py --start 2022-01-01        # 從 2022-01-01 開始回測
  python backtest_v5_no_filter.py --start 2021-01-01 --end 2023-12-31  # 指定完整日期範圍
        '''
    )
    parser.add_argument(
        '--start', 
...
def main():
    ...
    meta_20d = lstm_20d_module.select_best_model(start_date.date())
    if meta_20d is None:
        print("[Error] 找不到符合日期範圍的 T+20 模型")
        sys.exit(1)
    ...
    hybrid._LSTM_MODELS.update({
        ...
        'scaler_tgt_20d': scaler_tgt_20d, 'meta_20d': meta_20d, 'loaded': True
    })
