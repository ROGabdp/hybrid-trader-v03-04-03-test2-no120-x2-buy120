...
"""
================================================================================
Daily Operations V5 - Fixed LSTM 盤後分析 (No Filter Mode)
================================================================================
盤後執行腳本 - 使用 V5 模型 (對稱獎勵訓練) + 固定 LSTM 模型
...
5. 輸出結果到 daily_runs_v5_fixed/{date}/
...
DAILY_RUNS_PATH = os.path.join(PROJECT_PATH, 'daily_runs_v5_fixed')  # V5 Fixed LSTM 專用資料夾
...
def generate_report(workspace: dict, df: pd.DataFrame, res: dict, date_str: str, 
    ...
    print("\n" + "=" * 60)
    print("📊 Step 4: 盤後分析報告 (V5 Fixed LSTM)")
    print("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='V5 盤後分析系統 (Fixed LSTM + No Filter)',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
使用範例:
  python daily_ops_v5_fixed_lstm.py                    # 使用最新回測結果
  python daily_ops_v5_fixed_lstm.py -i                 # 互動式選擇回測 CSV
  python daily_ops_v5_fixed_lstm.py --backtest-start 2025-01-02  # 指定回測起始日
        '''
    )
    parser.add_argument(
        '-i', '--interactive',
    ...
    print("=" * 60)
    print(f"🚀 V5 盤後分析系統 (Fixed LSTM + No Filter) - {date_str}")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("✅ V5 盤後分析完成 (Fixed LSTM + No Filter)！")
    print("=" * 60)
